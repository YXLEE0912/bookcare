...
public class CreatePostDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        // --- View and listener setup remains the same ---
        ...
        // Set the action buttons on the builder
        ...
        builder.setNegativeButton("Cancel", (d, id) -> getDialog().cancel());

        // Create the dialog from the builder *once*
        ...
        // *** THIS IS THE FIX ***
        // Return the 'dialog' object that you have already modified.
        return dialog;
    }
