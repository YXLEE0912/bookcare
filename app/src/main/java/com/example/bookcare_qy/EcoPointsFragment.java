    ...
    private void loadUserPointsAndCalculate() {
        ...
        userEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                // Total books for exchange = only booksExchanged (no credits)
                int totalExchangeBooks = booksExchanged;
                // Display count
                if (binding.textView13 != null) {
                    binding.textView13.setText(totalExchangeBooks + " exchanges");
                }
                
                // Calculate and display points from exchanges: booksExchanged * 5
                int pointsFromExchanges = totalExchangeBooks * Constants.POINTS_PER_BOOK_EXCHANGE;
