...
public class UserProfileFragment extends Fragment implements RecommendationAdapter.OnItemClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.post(() -> {
            if (binding.imageViewProfile != null) {
        ...
        userEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (user != null) {
                    ...
                    // Update eco points display - same calculation as EcoPointsFragment
                    if (binding.textViewEcoPointsValue != null) {
                        ...
                        int totalPoints = pointsFromExchanges + pointsFromDonations;
